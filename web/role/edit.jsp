...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${pengchong:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${pengchong:in(role.resourceIds, r.id)}},
                </c:if>
                </c:forEach>
            ];
